...
def extract_chemitry_relation():
    with open("/home/yuan/Code/PycharmProjects/DrugBest/Data/draft/ChemOnt_2_1.obo") as f:
        content = f.read()
    ...
    for drug_elem in tree.findall("drug"):
        ...
        if parent is not None:
            ...
            if drug_name in id_drugNchem_dict.keys() and pname in id_drugNchem_dict.keys():
                edge_list.extend([id_drugNchem_dict[drug_name], id_drugNchem_dict[pname]])
