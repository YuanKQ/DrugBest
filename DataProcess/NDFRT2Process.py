...
__description__== 处理ndfrt("Data/draft/NDFRT_Public_2017.10.02_TDE.xml")的药物特征PHYSIOLOGIC_EFFECT, MECHANISM_OF_ACTION,
                  ...
                  "Data/drug_actionCode_matrix_dict.pickle": 字典结构, 长度为1388, key为药物(全小写), actionCode用长度为626的np.array来表示
                  "Data/drug_physiologicalCode_matrix_dict.pickle": 字典结构, 长度为1321, key为药物(全小写), physiologicalCode用长度为1866的np.array来表示


"""
import xml.etree.cElementTree as ET

from DataProcess.util import get_all_drugs_as_sets,calculate_TFIDF
import numpy as np
import pickle
...
if __name__ == '__main__':
    ...
    with open("/home/yuan/Code/PycharmProjects/DrugBest/Data/drug_actionCode_matrix_dict.pickle", "wb") as wf:
        pickle.dump(drug_actionCode_matrix_dict, wf)
    with open("/home/yuan/Code/PycharmProjects/DrugBest/Data/drug_physiologicalCode_matrix_dict.pickle", "wb") as wf:
